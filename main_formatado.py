...
from PySide6.QtWidgets import (
                ...
                QCompleter, QProgressBar, QHBoxLayout, QLineEdit, QFontDialog, QTextEdit, QScrollArea,
...
class CodeFormatterPlugin(PluginBase):
                ...
                def get_actions(self):
                                format_action = QAction("🚀 Formatador Avançado", self.ide)
    ...
    self.snippets, f, indent=2, ensure_ascii=False)
                ...
                def get_actions(self):
                                actions = [
                                                ...
                                                QAction("📋 Gerenciar Snippets", self.ide)
                                ]
...
class FormatDialog(QDialog):
                ...
                def format_code(self):
                                ...
                                if current_editor:
                                                ...
                                                self.preview_edit.setPlainText(formatted)
...
class DeployDialog(QDialog):
                ...
                def update_config_fields(self, deploy_type):
                                ...
                                if deploy_type == "zip":
                                                ...
                                                self.config_layout.addWidget(self.output_dir)

                                elif deploy_type == "git":
                                                self.config_layout.addWidget(
                                                    QLabel("Repositório remoto:"))
                                                self.remote = QLineEdit("origin")
                                                self.config_layout.addWidget(self.remote)

                                                self.config_layout.addWidget(QLabel("Branch:"))
                                                self.branch = QLineEdit("main")
                                                self.config_layout.addWidget(self.branch)

                                                self.config_layout.addWidget(
                                                    QLabel("Mensagem do commit:"))
                                                self.commit_message = QLineEdit("Deploy automático")
                                                self.config_layout.addWidget(self.commit_message)

                                elif deploy_type == "ftp":
                                                self.config_layout.addWidget(
                                                    QLabel("Servidor FTP:"))
                                                self.ftp_server = QLineEdit()
                                                self.config_layout.addWidget(self.ftp_server)

                                                self.config_layout.addWidget(QLabel("Usuário:"))
                                                self.ftp_user = QLineEdit()
                                                self.config_layout.addWidget(self.ftp_user)

                                                self.config_layout.addWidget(QLabel("Senha:"))
                                                self.ftp_password = QLineEdit()
                                                self.ftp_password.setEchoMode(QLineEdit.Password)
                                                self.config_layout.addWidget(self.ftp_password)
...
class ContextAwareCompleter:
                ...
                def get_completions(self, code, cursor_position, file_path="", project_path=""):
                                """Obtém sugestões baseadas no contexto"""
                                analysis = self.analyzer.analyze_code(code, file_path)
                                context = self.get_current_context(code, cursor_position)
                                ...
                                if context['type'] == 'import':
                                                ...
                                                return self.get_general_completions(analysis)
                ...
                def get_current_context(self, code, cursor_position):
                                ...
                                if 'import' in current_line:
                                                ...
                                                line_before_dot = current_line.rstrip()[:-1]
...
class PythonVersionManager:
                ...
                def get_available_versions(self):
                                ...
                                # Em produção, você faria web scraping do site oficial do Python
                                self.available_versions = [
...
class HybridCompleter:
                ...
                def get_completions(self, text, cursor_position, file_path="", project_path=""):
                                ...
                                if self.jedi_completer:
                                                try:
                                                                # Calcula linha e coluna para Jedi
                                                                ...
                                                                suggestions.update(jedi_suggestions)
                                                except Exception as e:
...
class PythonVersionDialog(QDialog):
                ...
                def setup_ui(self):
                                ...
                                installed_layout.addWidget(QLabel("Versões Python Instaladas:"))
                                ...
                                self.refresh_btn.clicked.connect(self.refresh_installed_versions)
    ...
    QLabel("Versões Disponíveis para Download:"))
                                ...
                                self.download_btn = QPushButton("🌐 Abrir Página de Download")
                ...
                def load_available_versions(self):
                                ...
                                for version in versions:
                                                self.available_list.addItem(version['version'])
    ...
    self, "Sucesso", f"Python padrão definido para:\n{new_default}")
                                                if hasattr(self.parent(), 'update_python_version'):
...
class AdvancedFindSimilarDialog(QDialog):
                ...
                def setup_ui(self):
                                ...
                                search_field_layout.addWidget(QLabel("Texto para buscar:"))
                                ...
                                self.results_count = QLabel("Digite um texto para buscar...")
                                results_layout.addWidget(self.results_count)

                                # Lista de resultados
                                self.results_list = QListWidget()
                                self.results_list.itemDoubleClicked.connect(self.go_to_match)
                ...
                def replace_all(self):
                                ...
                                if ok and new_text is not None:
                                                # Ordena por posição (decrescente) para evitar
...
class ThemeManager:
                ...
                def get_theme(self, theme_name):
                                return self.themes.get(theme_name, self.themes["Dark Professional"])
...
class ThemeDialog(QDialog):
                ...
                def setup_ui(self):
                                ...
                                self.theme_list.addItems(self.theme_manager.get_theme_names())
                                ...
                                def hello_world():
                                                ...
                                                name = "Mundo"
                                                number = 42
                                                print(f"Olá, {name}!")  # Saída: Olá, Mundo!
                                                return number
...
class IndentationChecker:
                ...
                def check_code(self, code, filename="<string>"):
                                ...
                                try:
                                                # Tenta compilar o código para detectar erros de
                                                # sintaxe
                ...
                def _parse_python_file_robust(self, file_path: str) -> Set[str]:
                                ...
                                try:
                                                ...
                                                try:
                                                                ...
                                                                # Fallback regex para arquivos com
    ...
    project_path,
     selected_text=""):
                ...
                def get_fallback_suggestions(self):
                                ...
                                functions = re.findall(r'def\s+([a-zA-Z_][a-zA-Z0-9_]*)', self.text)
    ...
    'type': 'attribute', 'object': obj_name}
                ...
                def get_from_import_suggestions(self, module_name):
                                ...
                                hardcoded_stdlib = {
                                                ...
                                                # Adicione mais: 'collections': ['defaultdict',
                                                # 'namedtuple', 'Counter', 'deque'], etc.
                                }
...
class MultiLanguageHighlighter(QSyntaxHighlighter):
                def __init__(self, parent=None):
                                ...
                                self.warning_format.setBackground(QColor(255, 255, 0, 128))
...
class AutoCompleteWidget(QListWidget):
                ...
                def insert_current_completion(self):
                                ...
                                if current_item:
                                                ...
                                                # Encontra a palavra atual para substituir
                                                cursor.select(QTextCursor.WordUnderCursor)
                                                current_word = cursor.selectedText()

                                                # Se estiver no meio de uma palavra, move para o fim
                                                if not current_word:
                                                                cursor.movePosition(
...
class CodeEditor(QPlainTextEdit):
                ...
                def is_inside_comment(self):
                                ...
                                line_without_strings = self.remove_strings_from_line(current_line)
                ...
                def on_text_changed(self):
                                ...
                                try:
                                                ...
                                                # Dispara autocomplete em situações específicas
                                                trigger_chars = ['.', ' ', '(', '=']
    ...
    QTextCursor.Left, QTextCursor.KeepAnchor)
                ...
                def remove_strings_from_line(self, line):
                                ...
                                # Simples remoção de strings entre aspas simples e duplas
                ...
                def update_cursor_info(self):
                                ...
                                try:
                                                ...
                                                # Verifica se os componentes da UI existem
                                                if not hasattr(
    self, 'cursor_info_label') or not self.cursor_info_label:
                                                ...
                                                print(f"Erro em update_cursor_info: {e}")
                                                # Não propaga a exceção para não quebrar a aplicação
...
class PackageDialog(QDialog):
                ...
                def package_project(self):
                                ...
                                try:
                                                # Exemplo simples: cria um ZIP ou use subprocess
                                                # para PyInstaller
                                                output_dir = os.path.join(self.project_path, "dist")
                                                os.makedirs(output_dir, exist_ok=True)

                                                # Comando exemplo com PyInstaller (ajuste conforme
                                                # necessário)
                                                pyinstaller_cmd = [
...
class TerminalTextEdit(QPlainTextEdit):
                ...
                def append_output(self, data):
                                ...
                                try:
                                                ...
                                                if current_text.endswith(">>> "):
                                                                # Remove o prompt temporariamente
                                                                self.setPlainText(
                                                                    current_text[:-4] + data + "\n>>> ")
                                                else:
                ...
                def restart_shell(self):
                                ...
                                try:
                                                ide = self.get_ide()
                                                if ide:
                                                                # Para processo anterior de forma
                                                                # segura
...
class SymbolCollector(ast.NodeVisitor):
                ...
                def visit_Name(self, node):
                                ...
                                if isinstance(node.ctx, ast.Store):
                                                self.local_symbols['variables'].add(node.id)
                                self.generic_visit(node)
...
class FindSimilarDialog(QDialog):
                ...
                def setup_ui(self):
                                ...
                                self.case_sensitive = QCheckBox("Diferenciar maiúsc/minúsc")
                                ...
                                self.results_list = QListWidget()
                                self.results_list.itemDoubleClicked.connect(self.go_to_match)
                                layout.addWidget(QLabel("Textos Similares Encontrados:"))
                                layout.addWidget(self.results_list)
                ...
                def find_similar(self):
                                ...
                                if not search_text:
                                                self.results_list.clear()
                                                self.stats_label.setText("Nenhuma busca realizada")
                                                return
...
class IDE(QMainWindow):
    ...
    QDockWidget.DockWidgetMovable | QDockWidget.DockWidgetFloatable)
                ...
                def open_python_version_manager(self):
                                ...
                                dialog = PythonVersionDialog(self.python_version_manager, self)
                                dialog.exec()
    ...
    QPalette.AlternateBase, QColor(
        colors["selection"]))
                ...
                def apply_syntax_theme(self, theme):
                                ...
                                # Para este exemplo, vamos apenas atualizar os editores abertos
                                for i in range(self.tab_widget.count()):
                                                widget = self.tab_widget.widget(i)
                                                if isinstance(widget, EditorTab):
                                                                # Aqui você atualizaria o
                                                                # highlighter com as novas cores
                                                                pass
    ...
    f"❌ Encontrados {len(errors)} erro(s) de indentação", 5000)
                ...
                def schedule_linting(self):
                                ...
                                if (current_content != self.last_lint_content and
                                                ...
                                                if self.is_linting:
                                                                ...
                                                                # Usa QTimer para linting
                                                                QTimer.singleShot(
                                                                    2000, self.run_linter)

                                                # Verifica indentação imediatamente (mais rápido)
                ...
                def update_cursor_info(self):
                                ...
                                if editor:
                                                ...
                                                # Atualiza também as informações do arquivo
                                                if hasattr(
    ...
    self, "Informação", "Apenas arquivos Python podem ser executados.")
                                ...
                                try:
                                                ...
                                                # Configura o processo para capturar saída em tempo
                                                # real
    ...
    self, "Informação", "Nenhum arquivo para depurar.")
                                ...
                                try:
                                                ...
                                                self.output_tabs.setCurrentIndex(debug_index)
                ...
                def show_find_dialog(self):
                                ...
                                if ok and find_text:
                                                ...
                                                if not cursor.isNull():
                                                                ...
                                                                # Busca do início se não encontrou
...
""")
    ...
    self, "Informação", "Apenas arquivos Python podem ser analisados.")
                ...
                try:
                                ...
                                self.shell_process.readyReadStandardOutput.connect(
                                    self.handle_terminal_output)
                                self.shell_process.readyReadStandardError.connect(
                ...
                try:
                                if (not hasattr(self, 'shell_process') or not self.shell_process or
                                                self.shell_process.state() != QProcess.Running):
                                                return
                                ...
                                if self.project_path:
                                                ...
                                                if hasattr(
    self, 'venv_path') and self.venv_path and os.path.exists(
        self.venv_path):
                                                                if os.name == 'nt':
                                                                                activate_cmd = f'"{os.path.join(self.venv_path, "Scripts", "activate")}"\n'
                                                                else:
                ...
                try:
                                ...
                                if hasattr(self, 'shell_process') and self.shell_process:
                                                if self.shell_process.state() == QProcess.Running:
                                                                ...
                                                                if not self.shell_process.waitForFinished(
                                                                    1000):
                                ...
                                if self.project_path:
                                                self.shell_process.setWorkingDirectory(
                                                    self.project_path)
            ...
            def handle_terminal_error(self):
                ...
                class IDE(QMainWindow):
                                                ...
                                                try:
                                                                ...
                                                                if hasattr(self, 'plugin_manager'):
                                                                                try:
                                                                                                ...
                                                                                                print(f"Erro ao finalizar plugins: {e}")
                                ...
                                def stop_all_processes(self):
                                                """Para todos os processos de forma segura"""
                                                processes = [
                                ...
                                def stop_all_workers(self):
                                                ...
                                                workers = [
                                                                getattr(self, 'linter_worker', None),
                                                                getattr(self, 'auto_complete_worker', None),
                                                                getattr(self, 'debug_worker', None)
                                                ]
                                                ...
                                                for worker in workers:
                                                                if worker and hasattr(worker, 'isRunning') and worker.isRunning():
                                                                                try:
                                                                                                ...
                                                                                                print(f"Erro ao parar worker: {e}")

                                def cleanup_references(self):
                                                """Limpa referências para ajudar o garbage collector"""
                                                refs_to_clear = [
                                                                'shell_process', 'debug_process', 'current_process',
                                                                'linter_worker', 'auto_complete_worker', 'debug_worker',
                                                                'plugin_manager', 'file_model', 'file_tree', 'tab_widget'
                                                ]

                                                for ref_name in refs_to_clear:
